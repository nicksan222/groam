...
const filter =
  '[0:v]fps=5,scale=640:-1:flags=lanczos,split[frames][palette-input];[palette-input]palettegen=max_colors=64:stats_mode=diff[palette];[frames][palette]paletteuse=dither=bayer:bayer_scale=5:diff_mode=rectangle';
