...
import { Separator } from '@groam/ui/components/separator';
import {
  Sheet,
  SheetContent,
  SheetDescription,
...
import { SidebarContext, type SidebarContextValue, useSidebar } from '@groam/ui/hooks/use-sidebar';
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            'group/sidebar-wrapper has-[[data-slot=sidebar][data-variant=inset]]:bg-sidebar flex min-h-svh w-full max-w-[100vw] min-w-0 overflow-x-hidden',
            className
          )}
          {...props}
        >
...
const SIDEBAR_MENU_BUTTON_VARIANTS: Record<SidebarMenuButtonVariant, string> = {
  default: 'hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
  outline:
    'bg-background shadow-[0_0_0_1px_var(--sidebar-border)] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground hover:shadow-[0_0_0_1px_var(--sidebar-accent)]'
};
const SIDEBAR_MENU_BUTTON_SIZES: Record<SidebarMenuButtonSize, string> = {
  default: 'h-8 text-sm',
  sm: 'h-7 text-xs',
  ...
  const button = (
    <Comp
      ...
      className={cn(
        ...
        SIDEBAR_MENU_BUTTON_VARIANTS[variant],
        SIDEBAR_MENU_BUTTON_SIZES[size],
        className
      )}
